...
OPENCV_MODULES:=stitching superres videostab photo aruco bgsegm bioinspired ccalib dpm face fuzzy img_hash line_descriptor optflow reg rgbd saliency stereo structured_light phase_unwrapping surface_matching tracking datasets text dnn plot ml xfeatures2d shape video ximgproc calib3d features2d highgui videoio flann xobjdetect imgcodecs objdetect xphoto imgproc core
